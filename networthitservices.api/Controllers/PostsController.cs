...
namespace networthitservices.api.Controllers
{
    ...
    public class PostsController : Controller
    {
        ...
        public PostsController(NetworthitservicesContext context)
        {
            _context = context;
        }
        ...
        public IEnumerable<object> GetPosts()
        {
            return _context.Posts
                .Select(a => new { a.Category.Category, a.PostTitle, a.Slug, a.PostMessage, a.DatePublished, a.CreatedBy });
        }
        ...
        public async Task<IActionResult> GetPosts([FromRoute] int id)
        {
            ...
            var posts = await _context.Posts
                .Select(a => new { a.Category.Category, a.PostId, a.PostTitle, a.Slug, a.PostMessage, a.DatePublished, a.CreatedBy })
